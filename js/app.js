                ...
                if (cursor){
                    ...
                    listadoClientes.innerHTML += ` <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5">
                              ...
                              Editar</a>
                                <a href="#" data-cliente="${id}" class="text-red-600 hover:text-red-900"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 inline-block">
